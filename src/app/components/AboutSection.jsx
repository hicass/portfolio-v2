      ...
      <Fade>
        ...
        <div id="about-contents">
          <p className="about-me-p">
            Creativity is at the heart of everything I do. I view coding as an
            art form, where every line of code has the potential to be elegant
            and expressive. I value the importance of visual appeal, attention
            to detail, and believe in the power that blending creativity and
            technology has.
          </p>
          <p className="about-me-p">
            ...
            cutting-edge tools and frameworks, continuously expanding my
            skillset.
          </p>
          <p className="about-me-p">
