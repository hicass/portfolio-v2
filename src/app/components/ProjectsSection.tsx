          ...
          <div>
            <div className="project-card-right-top">
              ...
              <p className="project-description">
                ...
                venture, managed by the fictional "Pepperoni family." Who stand
                out for their quirky ingredients of beards and oregano. I
                conceived this project to delve deeper into the world of React,
                simultaneously honing my frontend skills.
              </p>
            </div>
          ...
          <div>
            <div className="project-card-right-top">
              ...
              <p className="project-description">
                ...
                uses an emotion analysis API to accept or reject posts based on
                complaint-like sentiments. I developed and designed this project
                during my coding bootcamp, conquering the challenge of building
          ...
          <div>
            <div className="project-card-right-top">
              ...
              <p className="project-description">
                ...
                distributing the number of pebbles contained inside each of the
                pits counter-clockwise around the board, until there is a
                winner.
              </p>
            </div>
          ...
          <div>
            <div className="project-card-right-top">
              ...
              <p className="project-description">
                ...
                the beginning of my web development journey. A modern electronic
                rendition of the classic board game, the objective is to be the
                first to form a horizontal, vertical, or diagonal line of three
                of your markers, thereby securing victory.
              </p>
            </div>
