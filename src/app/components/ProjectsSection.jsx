                    ...
                    <div className='project-card-content'>
                        ...
                        <div className='project-card-back'>
                            ...
                            <div className='project-card-back-top'>
                                ...
                                <a className='project-link-container' href='https://github.com/hicass/tag-ops' target='_blank'>
                ...
                <div className='project-card'> {/* Chirp */}
                    <div className='project-card-content'>
                        ...
                        <div className='project-card-back'>
                            ...
                            <div className='project-card-back-top'>
                                <p className='project-description'>
                                    Chirp is a Twitter mock app specifically for complaining. 
                                    It uses an emotion analysis API to accept or reject posts based on 
                                    complaint-like sentiments. I developed and designed this project during my coding 
                    ...
                    <div className='project-card-content'>
                        ...
                        <div className='project-card-back'>
                            ...
                            <div className='project-card-back-top'>
                                ...
                                <a className='project-link-container' href='https://github.com/hicass/plantcollector' target='_blank'>
